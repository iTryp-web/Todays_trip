...
## 1. 프로젝트 소개
오늘의 여행은 리액트와 스프링을 활용한 여행 종합 플랫폼입니다.
<br><br><br>
...
- [이은재](https://github.com/77EJ77 "77EJ77 GitHub") : 장바구니(쿠키) / 주문 / 결제(아임포트 API) / 핸드폰 인증(NCP SENS API) / 챗봇(react simple chatbot)

- [최은경](https://github.com/Yanggang95 "Yanggang95 GitHub") : 회원가입(일반, 구글·카카오·네이버 API) / 로그인(일반, 구글·카카오·네이버 API) / 비밀번호 찾기(Spring Security) / 마이페이지(회원 정보 수정) / 이메일인증(Spring Boot Starter Mail)
<br><br><br>

## 3. 주요 기능
- 메인페이지

- 회원가입(일반, 구글·카카오·네이버 API)

- 로그인(일반, 구글·카카오·네이버 API)

- 비밀번호 찾기(Spring Security)

- 마이페이지(메인, 회원 정보 수정, 작성글 목록, 주문 목록, 리뷰 작성)

- 마켓(메인, 상세보기, 리뷰 수정·삭제·좋아요, 문의 작성·삭제, 상품 등록-firebase 실시간 데이터베이스)
...
- 고객센터(자주 묻는 질문, 챗봇, 1:1문의

- 관리자 페이지(마켓, 주문, 문의, 신고, 차단, 탈퇴)
<br><br><br>

## 4. 개발 환경
<img width=90% src="https://github.com/iTryp-web/Todays_trip/assets/115203308/d033880b-0a5b-494a-a44c-46539c019206.png">
<br><br><br>
