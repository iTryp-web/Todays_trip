...
CREATE TABLE "TB_SELLER" (
	"SELLER_AUTH"	VARCHAR(255)		NULL,
	"SELLER_CATEGORY"	VARCHAR(255)		NULL
);

DROP TABLE "Untitled8";
...
COMMENT ON COLUMN "Untitled8"."MARKET_NO" IS '상품 번호';

COMMENT ON COLUMN "Untitled8"."MARKET_A_DATE" IS '선택날짜하루씩';
...
CREATE TABLE "TB_ORDER" (
	...
	"MARKET_COUNT"	NUMBER(5)		NOT NULL,
	"USER_ID"	VARCHAR2(100)		NOT NULL,
	"ORDER_TOTAL"	NUMBER(100)		NOT NULL,
	"ORDER_DISCOUNT"	NUMBER(2)		NOT NULL,
	"COUPON_NO"	VARCHAR2(100)		NOT NULL,
	"ORDER_PAYMENT"	NUMBER(100)		NOT NULL,
