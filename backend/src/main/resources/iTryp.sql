...
CREATE TABLE "TB_U_COUPON" (
	...
	"COUPON_DATE"	VARCHAR2(32)	DEFAULT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS')	NULL,
...
CREATE TABLE "TB_BOARD" (
	...
	"BOARD_DATE"	VARCHAR2(32)	DEFAULT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS')	NULL,
...
CREATE TABLE "TB_B_COMMENT" (
	...
	"COMMENT_DATE"	VARCHAR2(32)	DEFAULT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS')	NULL
);
...
CREATE TABLE "TB_M_REVIEW" (
	...
	"REIVEW_DATE"	VARCHAR2(32)	DEFAULT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS')	NOT NULL
);
...
CREATE TABLE "TB_LIKE" (
	...
	"LIKE_GROUP"	NUMBER(10)		NOT NULL,
	"LIKE_STEP"	NUMBER(2)	DEFAULT 0	NULL,
	"LIKE_DATE"	VARCHAR2(32)	DEFAULT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS')	NOT NULL
);
...
COMMENT ON COLUMN "TB_LIKE"."LIKE_STEP" IS '대댓글 번호 댓글:0 / 대댓글:1';
...
CREATE TABLE "TB_MARKET" (
	...
	"MARKET_DATE"	VARCHAR2(32)	DEFAULT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS')	NOT NULL
);
...
CREATE TABLE "TB_REPORT" (
	...
	"REPRTO_GROUP"	NUMBER(10)		NOT NULL,
	"REPORT_STEP"	NUMBER(2)	DEFAULT 0	NULL,
	"REPORT_USER"	VARCHAR2(100)		NOT NULL,
	"REPORT_REASON"	VARCHAR2(200)		NOT NULL,
	"REPORT_DATE"	VARCHAR2(32)	DEFAULT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS')	NOT NULL,
...
COMMENT ON COLUMN "TB_REPORT"."REPRTO_GROUP" IS '해당 글, 댓글, 마켓글, 리뷰의 NO';
...
CREATE TABLE "TB_QNA" (
	...
	"QNA_DATE"	VARCHAR2(32)	DEFAULT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS')	NULL,
...
CREATE TABLE "TB_ORDER" (
	...
	"ORDER_DATE"	VARCHAR2(32)	DEFAULT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS')	NOT NULL
);
...
CREATE TABLE "TB_PAY" (
	...
	"PAY_DATE"	VARCHAR2(32)	DEFAULT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS')	NOT NULL,
...
CREATE TABLE "TB_HOT_DETAIL" (
	...
	"ITEM_ORDER_DATE"	VARCHAR2(32)	DEFAULT TO_CHAR(sysdate, 'YYYY-MM-DD HH24:MI:SS')	NOT NULL
);
