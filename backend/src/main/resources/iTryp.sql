...
CREATE TABLE "TB_B_COMMENT" (
	...
	"COMMENT_STEP"	NUMBER(2)	DEFAULT 0	NULL,
...
COMMENT ON COLUMN "TB_FILE"."BOARD_NO" IS '글 번호';

COMMENT ON COLUMN "TB_FILE"."FILE_NAME" IS '파일 이름';

COMMENT ON COLUMN "TB_FILE"."FILE_URL" IS '파일 url';
...
"REIVEW_DATE"	VARCHAR2(32)	DEFAULT SYSDATE	NOT NULL
);
...
COMMENT ON COLUMN "TB_M_REVIEW"."REIVEW_DATE" IS '리뷰 작성일';

DROP TABLE "TB_SELLER";

CREATE TABLE "TB_SELLER" (
"USER_ID"	VARCHAR2(100)		NOT NULL,
"SELLER_AUTH"	VARCHAR2(200)		NULL,
...
COMMENT ON COLUMN "TB_M_ABLE"."MARKET_A_DATE" IS '선택날짜하루씩';
...
"BOARD_NO"	NUMBER(10)		NOT NULL,
"BOARD_STEP"	NUMBER(2)	DEFAULT 0	NULL
);

COMMENT ON COLUMN "TB_LIKE"."USER_ID" IS '회원식별자';

COMMENT ON COLUMN "TB_LIKE"."LIKE_TYPE" IS '글:0/댓글:1/리뷰:2';

COMMENT ON COLUMN "TB_LIKE"."BOARD_NO" IS '글 번호';

COMMENT ON COLUMN "TB_LIKE"."BOARD_STEP" IS '대댓글 번호 댓글:0 / 대댓글:1';
...
CREATE TABLE "TB_MARKET" (
	"MARKET_NO"	NUMBER(10)		NOT NULL,
	"USER_ID"	VARCHAR2(100)		NOT NULL,
	"MARKET_CATEGORY"	VARCHAR2(32)		NULL,
	"MARKET_TITLE"	VARCHAR2(128)		NULL,
	"MARKET_CONTENT"	VARCHAR2(4000)		NULL,
	"MARKET_PRICE"	NUMBER(10)		NULL,
	"MARKET_DATE"	VARCHAR2(32)	DEFAULT SYSDATE	NULL
);
...
"REPORT_NO"	NUMBER(10)		NULL,
"USER_ID"	VARCHAR2(100)		NOT NULL,
"REPORT_TYPE"	NUMBER(10)		NOT NULL,
"REPORT_TYPE_STEP"	NUMBER(2)	DEFAULT 0	NOT NULL,
...
COMMENT ON COLUMN "TB_REPORT"."REPORT_TYPE_STEP" IS '대댓글 번호 댓글:0 / 대댓글:1';
...
COMMENT ON COLUMN "TB_REPORT"."REPORT_SORT" IS '신고 구분
글:0/댓글:1';
...
CREATE TABLE "TB_HOT" (
	...
	"ITEM_DATE"	VARCHAR2(32)	DEFAULT SYSDATE	NOT NULL,
...
COMMENT ON COLUMN "TB_HOT"."ITEM_DATE" IS '아이템 유효기간';

COMMENT ON COLUMN "TB_HOT"."ITEM_TYPE" IS '아이템 기능 분류
0:메인배너 /1:마켓/2:상위노출/3:강조아이콘 ..';

DROP TABLE "TB_CART";

CREATE TABLE "TB_CART" (
	"CART_NO"	NUMBER(38)		NOT NULL,
	"USER_ID"	VARCHAR2(100)		NOT NULL,
	"MARKET_NO"	NUMBER(10)		NOT NULL,
	"MARKET_COUNT"	NUMBER(5)		NOT NULL,
	"CART_DATE"	VARCHAR2(32)	DEFAULT SYSDATE	NOT NULL
);

COMMENT ON COLUMN "TB_CART"."CART_NO" IS '장바구니 번호';

COMMENT ON COLUMN "TB_CART"."USER_ID" IS '회원식별자';

COMMENT ON COLUMN "TB_CART"."MARKET_NO" IS '상품 번호';

COMMENT ON COLUMN "TB_CART"."MARKET_COUNT" IS '상품 수량';

COMMENT ON COLUMN "TB_CART"."CART_DATE" IS '장바구니 날짜';
...
CREATE TABLE "TB_ORDER" (
	...
	"MARKET_COUNT"	NUMBER(5)		NOT NULL,
	"USER_ID"	VARCHAR2(100)		NOT NULL,
	"ORDER_TOTAL"	NUMBER(38)		NOT NULL,
	"ORDER_DISCOUNT"	NUMBER(2)		NOT NULL,
	"COUPON_NO"	VARCHAR2(100)		NOT NULL,
	"ORDER_PAYMENT"	NUMBER(38)		NOT NULL,
	"ORDER_DATE"	VARCHAR2(32)	DEFAULT SYSDATE	NOT NULL
);

COMMENT ON COLUMN "TB_ORDER"."ORDER_NO" IS '주문 번호';

COMMENT ON COLUMN "TB_ORDER"."MARKET_NO" IS '상품 번호';

COMMENT ON COLUMN "TB_ORDER"."MARKET_COUNT" IS '상품 수량';
...
DROP SEQUENCE ITRYP.TB_CART_NO_SEQ;

CREATE SEQUENCE ITRYP.TB_CART_NO_SEQ
  START WITH 0
  MAXVALUE 999999999999999999999999999
  MINVALUE 0
  NOCYCLE
